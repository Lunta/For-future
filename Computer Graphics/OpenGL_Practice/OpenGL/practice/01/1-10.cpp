...
GLvoid drawScene(GLvoid)
{
	...
	glRectf(Blank, Blank, Window_Width - Blank, Window_Height - Blank);
	for (auto p : rcList)
	{
...
/*
퍼져나가는 점 그리기 (워밍업 문제 활용)
-영역을 설정하고, 영역내에 마우스로 클릭하는곳에 도형이 그려지고 시간마다 특정 방향으로 이동하다.
8방향중 한방향을 임의로 선택한다.
-도형은 커졌다 작아졌다 하면서 이동한다.
-최대 20개 까지의 도형이 있고 21개의 마우스를 클릭하면 1번의 도형이 없어진다.
-영역 밖으로 점이 나가면 그 도형은 없어진다.
*/