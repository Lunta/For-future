...
class Vector3D {
private:
	const float EffectiveEffer = 0.0001f; // 부동소수점 정밀도
...
template<typename Ty>
inline Vector3D<Ty> CrossProduct(const Vector3D<Ty> a, const Vector3D<Ty> b) { return Vector3D<Ty>(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x); }