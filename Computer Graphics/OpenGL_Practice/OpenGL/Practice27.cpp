...
bool CPractice27::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	switch (nMessageID)
	{
	case WM_KEYDOWN:
...
bool CPractice27::OnProcessingMouseMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	switch (nMessageID)
	{
	case WM_LBUTTONDOWN:
...
bool CPractice27::OnProcessingWindowMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	switch (nMessageID)
	{
	case WM_SIZE:
...
void CPractice27::BuildPractice(CMainScene * CurrentScene, HWND hWnd, CurrentPractice tag)
{
...
void CPractice27::Update(float fTimeElapsed)
{
	ProcessInput();
