...
class ImageManager:
    def __init__(self):
        ...
        self.SpriteImage_PlayerEffect_PowerUp = SpriteImage('Resource\\Graphics\\Sprite\\Effect\\Effect_PowerUp.png', 'Effect_PowerUp', 6)
        self.SpriteImage_PlayerEffect_PowerUp2 = SpriteImage('Resource\\Graphics\\Sprite\\Effect\\Effect_PowerUp2.png', 'Effect_PowerUp2', 10)
